...
export default function Background ({ mainColor, secondColor, children }) {
  return (
    <>
      <div style={{background: mainColor}} className={`w-full h-fit px-4 md:px-6 lg:px-12 pb-12 pt-32 md:pt-40 lg:pt-40 relative overflow-hidden `} >
        ...
        <svg className="md:hidden absolute top-0 right-0 " width="300" height="300" viewBox="0 0 300 300" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M0.0774595 0C120.465 246.051 300 167.37 300 167.37V300C135.166 282.921 -3.7552 69.6574 0.0774595 0Z" fill={secondColor} />
        </svg>
        <svg className="md:hidden absolute bottom-0 left-0 " width="300" height="300" viewBox="0 0 300 300" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M299.923 300C179.535 53.9494 0 132.63 0 132.63V0C164.834 17.0791 303.755 230.343 299.923 300Z" fill={secondColor} />
        </svg>
        <div style={{color: secondColor}} className={`absolute right-0 md:bottom-60 lg:bottom-0 text-9xl hidden md:block `} >
          Coffee <br />
          Corner
        </div>
